...
file_1 = open('internaldomainlist.txt', 'r')
file_2 = open('comparing-list.txt', 'r')

print("Comparing files ", " >> " + 'internaldomainlist.txt', " << " + 'comparinglist.txt', sep='\n')
...
with open('internaldomainlist.txt') as file1:
	with open('comparinglist.txt') as file2:
